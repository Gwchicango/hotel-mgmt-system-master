...
<div class="container py-5">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center mb-5">Iniciar sesión en el sistema de gestión hotelera</h2>
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card border-secondary">
                        <div class="card-header">
                            <h3 class="mb-0 my-2">Iniciar sesión</h3>
                        </div>
                        <div class="card-body">
                            <?php if (isset($error)): ?>
                            ...
                            <form class="form" role="form" autocomplete="off" id="login-form" method="post">
                                ...
                                <div class="form-group">
                                    <p>No registrado? <a href="register.php">Registrar aquí.</a></p>
                                </div>
                                <div class="form-group">
